...
following are now true:
    ...
    criteria (the repeated 44 is part of a larger group of 444).
...
bool complies(int n)
{
    ...
    while (n)
    {
        ...
        if (digit == prev_digit) same_adjacent = true;
...
bool complies2(int n)
{
    ...
    while (n)
    {
        ...
        else if (same_adjacent != 0)
        {
            if (same_adjacent == 1) same_two = true;
            same_adjacent = 0;
        }
